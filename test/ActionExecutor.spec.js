...
describe("ActionExecutor", function() {
  it("should export ActionCancelledError", function() {
    expect(ActionExecutor.ActionCancelledError, "to be", ActionCancelledError);
  });

  it("should export ActionNotReadyError", function() {
    expect(ActionExecutor.ActionNotReadyError, "to be", ActionNotReadyError);
  });
});
...
describe("actions.ActionExecutor.enqueue", function() {
  ...
  expect.addAssertion("emitted status events", function(
    expect,
    subject,
    expectedEvents
  ) {
  ...
  describe("error handling", function() {
    ...
    it("fails when given an action that has no name", function() {
      expect(
        ...
        "to throw",
        /Expect actions to have an unique name/
      );
    });
    ...
    it("fails when given an action that has no execute method", function() {
      expect(
        ...
        "to throw",
        /Expect actions to have an execute method/
      );
    });
  });
