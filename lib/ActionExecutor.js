(function (root, factory) {
    if (typeof exports === 'object') {
        module.exports = factory(require('./actionUtils'), require('./ActionNotReadyError'), require('./ActionCancelledError'));
    } else if (typeof define === 'function' && define.amd) {
        define(['./actionUtils', './ActionNotReadyError', './ActionCancelledError'], factory);
    } else {
        root.com = root.com || {};
        root.com.one = root.com.one || {};
        root.com.one.ActionExecutor = factory(root.com.one.actionUtils, root.com.one.ActionNotReadyError, root.com.one.ActionCancelledError);
    }
}(this, function (util, ActionNotReadyError, ActionCancelledError) {
